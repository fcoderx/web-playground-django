...
class ThreadTestCase(TestCase):
    ...
    # Creamos los test (El nombre siempre debe de llevar 'test_' al principio, ejem: 'test_usuarios' )
    ...
    def test_add_messages_to_thread(self):
        self.thread.users.add(self.user1, self.user2)
        message1 = Message.objects.create(user=self.user1, content="Buenas tardes")
